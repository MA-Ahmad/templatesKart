...
const Icon = () => {
  return (
    ...
    >
      ...
      <rect x="47" y="5" width="60" height="25" fill="#A8A9AB" />
      <circle cx="50" cy="36" r="3" fill="#D9D9D9" />
      <line x1="55" y1="36" x2="69" y2="36" stroke="#3769B4" stroke-width="2" />
      <line x1="47" y1="41.5" x2="96" y2="41.5" stroke="#D9D9D9" />
      <path d="M47 44.5H101" stroke="#D9D9D9" />
      <path d="M47 47.5H92" stroke="#D9D9D9" />
      <path d="M107 52H47V77H107V52Z" fill="#A8A9AB" />
      <path
        ...
        fill="#D9D9D9"
      />
      <path d="M55 83H69" stroke="#3769B4" stroke-width="2" />
