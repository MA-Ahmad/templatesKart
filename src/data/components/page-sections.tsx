  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_27_280)">
        ...
        <path d="M36 27H10V30H36V27Z" fill="#3769B4" />
        ...
        <path d="M36 67H10V70H36V67Z" fill="#3769B4" />
        <path d="M70 67H44V70H70V67Z" fill="#3769B4" />
        ...
        <path
          ...
          fill="#ECE9E9"
        />
        <line x1="86" y1="43.25" x2="100" y2="43.25" stroke="#3769B4" stroke-width="1.5" />
        <path d="M120 43.5H134" stroke="#3769B4" stroke-width="1.5" />
