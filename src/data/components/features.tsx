  ...
  return (
    ...
    >
      ...
      <rect
        ...
        stroke-width="0.1"
      />
      <path d="M25 59.5H44" stroke="#D9D9D9" />
      <path d="M23 57.5H46" stroke="#D9D9D9" />
      <line x1="26" y1="49.5" x2="43" y2="49.5" stroke="#A8A9AB" stroke-width="3" />
      <line x1="23" y1="55.5" x2="46" y2="55.5" stroke="#D9D9D9" />
      <path
      ...
      <path
        ...
        stroke-width="0.1"
      />
      <path d="M67.95 59.45H86.95" stroke="#D9D9D9" />
      <path d="M65.95 57.45H88.95" stroke="#D9D9D9" />
      <path d="M68.95 49.45H85.95" stroke="#A8A9AB" stroke-width="3" />
      <path d="M65.95 55.45H88.95" stroke="#D9D9D9" />
      <path
      ...
      <path
        ...
        stroke-width="0.1"
      />
      <path d="M110.95 59.45H129.95" stroke="#D9D9D9" />
      <path d="M108.95 57.45H131.95" stroke="#D9D9D9" />
      <path d="M111.95 49.45H128.95" stroke="#A8A9AB" stroke-width="3" />
      <path d="M108.95 55.45H131.95" stroke="#D9D9D9" />
      <path
